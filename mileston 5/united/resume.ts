...
// shareable link code=======================================================
    let url = ' file:///C:/Users/dell/Desktop/resume/mileston%205/resume.html';
    
    let linkTag = (document.getElementById('link-tag')as HTMLAnchorElement);
    let linkbtn =document.getElementById('link-btn') as HTMLButtonElement;

    linkbtn.addEventListener('click' ,()=>{
        linkTag.textContent=(url + (userName1?.toLowerCase().replace(/\s+/g ,"-")))
        linkTag.setAttribute("href",(url + userName1));
...
// download button download===========================================================
    ...
    let Editbtn =document.getElementById('Edit-btn') as HTMLButtonElement;

...
// shareable link code=======================================================
var url = ' file:///C:/Users/dell/Desktop/resume/mileston%205/resume.html';
var linkTag = document.getElementById('link-tag');
var linkbtn = document.getElementById('link-btn');
linkbtn.addEventListener('click', function () {
    linkTag.textContent = (url + (userName1 === null || userName1 === void 0 ? void 0 : userName1.toLowerCase().replace(/\s+/g, "-")));
